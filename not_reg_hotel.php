        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
                  <hr />
                   <h1 style="color: red" align="center"> Hotels  Details : Not verified emails</h1>
				...
				<tbody>
					<?php 
							$today = date("y-m-d");
							$user = new Functions;
							$users = $user->fetch_all_hotel_not_reg();
					...
					<tr>
						...
						<td>
							<?php echo $user['fromdate'];?> to  <?php echo $user['tilldate'];?>
						</td>
						<td>
